# Public Records Act request — Los Angeles County Agricultural Commissioner

**To:** Los Angeles County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** losangag@acwm.lacounty.gov  ·  records method: Email to the Agricultural Commissioner/Weights & Measures records unit  ·  source: CDFA commissioner directory
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by Los Angeles County (county code **19**), together with
...
---
*Los Angeles = 353,997 mapped applications with no operator name yet (county code 19). Drafted 2026-08-02 for the coverage-gap audit.*
