# Public Records Act request — Sacramento County Agricultural Commissioner

**To:** Sacramento County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** agcomm@saccounty.gov  ·  records method: Email; Sacramento County NextRequest portal as fallback  ·  source: CDFA commissioner directory
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by Sacramento County (county code **34**), together with
...
---
*Sacramento = 135,543 mapped applications with no operator name yet (county code 34). Drafted 2026-08-02 for the coverage-gap audit.*
