# Public Records Act request — Butte County Agricultural Commissioner

**To:** Butte County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** butteag@buttecounty.ca.gov  ·  records method: Email; Butte County also accepts PRA requests via its Clerk of the Board  ·  source: CDFA commissioner directory
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by Butte County (county code **04**), together with
...
---
*Butte = 246,417 mapped applications with no operator name yet (county code 04). Drafted 2026-08-02 for the coverage-gap audit.*
