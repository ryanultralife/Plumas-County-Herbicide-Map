# Public Records Act request — Tehama County Agricultural Commissioner

**To:** Tehama County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** tmoss@tehama.gov  ·  records method: Email to the Agricultural Commissioner  ·  source: CDFA commissioner directory
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by Tehama County (county code **52**), together with
...
---
*Tehama = 154,053 mapped applications with no operator name yet (county code 52). Drafted 2026-08-02 for the coverage-gap audit.*
