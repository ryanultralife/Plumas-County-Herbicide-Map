# Public Records Act request — Monterey County Agricultural Commissioner

**To:** Monterey County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** agcomm@co.monterey.ca.us  ·  records method: Email, or county NextRequest portal https://countyofmontereyca.nextrequest.com/  ·  source: CDFA commissioner directory + countyofmonterey.gov
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by Monterey County (county code **27**), together with
...
---
*Generated by build/gen_records_requests.py. Monterey = 1,774,025 mapped applications, 2020–2026.*
