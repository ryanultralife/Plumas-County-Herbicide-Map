# Public Records Act request — Imperial County Agricultural Commissioner

**To:** Imperial County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** pue@co.imperial.ca.us  ·  records method: Email the Pesticide Use Enforcement division (general office: agcom@co.imperial.ca.us)  ·  source: agcom.imperialcounty.org PUE page
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by Imperial County (county code **13**), together with
...
---
*Generated by build/gen_records_requests.py. Imperial = 265,655 mapped applications, 2020–2026.*
