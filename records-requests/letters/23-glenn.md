# Public Records Act request — Glenn County Agricultural Commissioner

**To:** Glenn County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** agcommr@countyofglenn.net  ·  records method: Email to the Agricultural Commissioner  ·  source: CDFA commissioner directory
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by Glenn County (county code **11**), together with
...
---
*Glenn = 116,770 mapped applications with no operator name yet (county code 11). Drafted 2026-08-02 for the coverage-gap audit.*
