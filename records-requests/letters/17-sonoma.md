# Public Records Act request — Sonoma County Agricultural Commissioner

**To:** Sonoma County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** sonomaag@sonoma-county.org  ·  records method: Email; Sonoma County NextRequest portal as fallback  ·  source: CDFA commissioner directory
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by Sonoma County (county code **49**), together with
...
---
*Sonoma = 207,337 mapped applications with no operator name yet (county code 49). Drafted 2026-08-02 for the coverage-gap audit.*
