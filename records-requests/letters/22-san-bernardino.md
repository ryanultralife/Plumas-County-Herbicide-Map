# Public Records Act request — San Bernardino County Agricultural Commissioner

**To:** San Bernardino County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** awm@awm.sbcounty.gov  ·  records method: Email to Agriculture/Weights & Measures  ·  source: CDFA commissioner directory
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by San Bernardino County (county code **36**), together with
...
---
*San Bernardino = 128,925 mapped applications with no operator name yet (county code 36). Drafted 2026-08-02 for the coverage-gap audit.*
