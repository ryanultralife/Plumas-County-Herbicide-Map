# Public Records Act request — Santa Clara County Agricultural Commissioner

**To:** Santa Clara County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** scc.agriculture@cep.sccgov.org  ·  records method: Email to the Dept. of Agriculture & Environmental Management  ·  source: CDFA commissioner directory
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by Santa Clara County (county code **43**), together with
...
---
*Santa Clara = 158,957 mapped applications with no operator name yet (county code 43). Drafted 2026-08-02 for the coverage-gap audit.*
