# Public Records Act request — San Luis Obispo County Agricultural Commissioner

**To:** San Luis Obispo County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** agcommslo@co.slo.ca.us  ·  records method: Email to the Agricultural Commissioner's office  ·  source: CDFA commissioner directory
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by San Luis Obispo County (county code **40**), together with
...
---
*San Luis Obispo = 216,752 mapped applications with no operator name yet (county code 40). Drafted 2026-08-02 for the coverage-gap audit.*
