# Public Records Act request — Madera County Agricultural Commissioner

**To:** Madera County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** MaderaPUE@maderacounty.com  ·  records method: Email the Pesticide Use Enforcement division (no portal). Please re-confirm — county site blocks automated checks  ·  source: maderacounty.com PUE pages + CalAgPermits
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by Madera County (county code **20**), together with
...
---
*Generated by build/gen_records_requests.py. Madera = 281,595 mapped applications, 2020–2026.*
