# Public Records Act request — Alameda County Agricultural Commissioner

**To:** Alameda County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** alameda.ag@acgov.org  ·  records method: Email to the Dept. of Agriculture  ·  source: CDFA commissioner directory
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by Alameda County (county code **01**), together with
...
---
*Alameda = 97,875 mapped applications with no operator name yet (county code 01). Drafted 2026-08-02 for the coverage-gap audit.*
