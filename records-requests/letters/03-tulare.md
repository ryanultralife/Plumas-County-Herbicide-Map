# Public Records Act request — Tulare County Agricultural Commissioner

**To:** Tulare County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** aginfo@tularecounty.ca.gov  ·  records method: Email, or NextRequest portal https://countyoftulareca.nextrequest.com/  ·  source: CDFA directory
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by Tulare County (county code **54**), together with
...
---
*Generated by build/gen_records_requests.py. Tulare = 858,909 mapped applications, 2020–2026.*
