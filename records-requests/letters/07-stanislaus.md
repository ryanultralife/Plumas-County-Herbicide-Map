# Public Records Act request — Stanislaus County Agricultural Commissioner

**To:** Stanislaus County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** agcom50@stancounty.com  ·  records method: Email or mail (office records form on stanag.org; no third-party portal)  ·  source: stanag.org public-information-records page
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by Stanislaus County (county code **50**), together with
...
---
*Generated by build/gen_records_requests.py. Stanislaus = 410,267 mapped applications, 2020–2026.*
