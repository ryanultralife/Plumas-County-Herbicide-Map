# Public Records Act request — Fresno County Agricultural Commissioner

**To:** Fresno County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** fresnoag@fresnocountyca.gov  ·  records method: Email, or NextRequest portal https://fresnocountyca.nextrequest.com/  ·  source: CDFA directory + fresnocountyca.gov
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by Fresno County (county code **10**), together with
...
---
*Generated by build/gen_records_requests.py. Fresno = 984,830 mapped applications, 2020–2026.*
