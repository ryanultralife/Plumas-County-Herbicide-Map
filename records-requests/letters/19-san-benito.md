# Public Records Act request — San Benito County Agricultural Commissioner

**To:** San Benito County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** kgriffin@cosb.us  ·  records method: Email to the Agricultural Commissioner  ·  source: CDFA commissioner directory
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by San Benito County (county code **35**), together with
...
---
*San Benito = 166,913 mapped applications with no operator name yet (county code 35). Drafted 2026-08-02 for the coverage-gap audit.*
