# Public Records Act request — Riverside County Agricultural Commissioner

**To:** Riverside County Agricultural Commissioner / Sealer of Weights & Measures
**Send to:** agdept@rivco.org  ·  records method: Email, or county NextRequest portal https://riversidecountyca.nextrequest.com/  ·  source: CDFA directory + rivcoawm.org
...
1. The current roster of **Operator Identification Numbers / Restricted Materials
   Permit numbers** issued by Riverside County (county code **33**), together with
...
---
*Generated by build/gen_records_requests.py. Riverside = 283,601 mapped applications, 2020–2026.*
